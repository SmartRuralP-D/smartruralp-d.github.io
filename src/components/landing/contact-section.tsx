...
export function ContactSection() {
    return (
        <section id="contato" className="bg-brand text-white">
            <div className="page-container grid min-h-140 grid-cols-[minmax(0,7fr)_minmax(230px,4fr)] items-end gap-10 py-25 max-[900px]:min-h-142.5 max-[900px]:py-21.25">
                ...
                <div className="pb-1.75 max-[900px]:pb-0">
                    ...
                    <a className="block w-fit border-b border-white/70 pb-2.5 text-base font-extrabold" href="mailto:contato@smartrural.com.br">
