...
export function ContactSection() {
    return (
        <section id="contato" className="bg-brand text-white">
            <div className="page-container grid min-h-140 grid-cols-[minmax(0,7fr)_minmax(230px,4fr)] items-end gap-10 py-25 max-[900px]:grid-cols-1 max-[900px]:items-start max-[900px]:gap-10 max-[900px]:min-h-142.5 max-[900px]:py-21.25">
