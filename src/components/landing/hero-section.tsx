...
export function HeroSection() {
    return (
        <section id="inicio" className="bg-canvas pt-[10.25rem]">
            <div className="page-container">
                <div className="grid items-end gap-9 pb-[3.875rem] [grid-template-columns:minmax(0,9fr)_minmax(8.75rem,2fr)] max-[900px]:grid-cols-1">
                    <div>
                        <SectionLabel>TECNOLOGIA APLICADA AO CAMPO</SectionLabel>
                        <h1 className="mb-7 mt-6 max-w-[57.5rem] text-[clamp(3.25rem,7.5vw,7.2rem)] font-semibold leading-[.96] tracking-[-.055em]">
                            Sua solução para monitoramento em <em className="text-brand not-italic">tempo real</em>
                        </h1>
                        <p className="mb-0 max-w-[37.5rem] text-[clamp(1rem,1.5vw,1.22rem)] leading-[1.65] text-text">
                        ...
                        <div className="mt-9 flex flex-wrap items-center gap-5">
                            <a
                                ...
                                href="#solucoes"
                            >
                                Conheça nossas soluções <ArrowUpRight className="ml-2.5 size-[1.0625rem]" aria-hidden="true" />
                            </a>
                            <a
                                className="inline-flex min-h-[3.125rem] items-center justify-center px-0 text-[0.8125rem] font-extrabold text-ink transition hover:-translate-y-0.5 hover:text-brand"
                                href="#contato"
                            >
                                Fale com a SmartRural <ArrowRight className="ml-2.5 size-[1.0625rem]" aria-hidden="true" />
                            </a>
                        </div>
                    </div>
                    <div className="grid content-end justify-items-start gap-5 pb-1 max-[900px]:hidden">
                        ...
                        <p className="mb-0 max-w-[9.375rem] text-[0.8125rem] leading-[1.5] text-muted">Do campo para perto de quem acompanha a operação.</p>
                        <a
                            className="grid size-[2.8125rem] place-items-center rounded-pill border border-border text-brand transition hover:bg-brand hover:text-white"
                            href="#solucoes"
                            aria-label="Conheça as soluções"
                        >
                            <ArrowDownRight className="size-[1.125rem]" aria-hidden="true" />
                        </a>
                    </div>
                </div>
                <figure className="relative h-[clamp(400px,53vw,670px)] overflow-hidden bg-inverse">
                    <img
                        ...
                        fetchPriority="high"
                    />
                    <figcaption className="absolute bottom-6 left-7 z-10 flex flex-wrap gap-[1.375rem] text-xs font-bold text-white">
                    ...
                    <div className="absolute right-8 top-8 z-10 grid w-[min(16.875rem,34%)] gap-2 rounded-none border-l-[3px] border-brand bg-[rgba(16,19,22,.78)] p-[1.0625rem_1.125rem] text-white backdrop-blur-lg max-[600px]:right-4 max-[600px]:top-4">
                        ...
                        <span className="inline-flex items-center gap-1.5 text-[0.6875rem] font-bold text-[#d5e4dc]">
                            <i className="size-[0.4375rem] rounded-pill bg-[#4bbd7a]" aria-hidden="true" /> Normal
                        </span>
                    </div>
                </figure>
                <div className="flex items-center justify-between gap-5 pt-[1.125rem] text-xs text-muted">
                    ...
                    <div className="flex gap-[1.5625rem]">
                        <span className="inline-flex items-center gap-1.5 font-bold text-text">
                            <i className="size-[0.4375rem] rounded-pill bg-[#4bbd7a]" aria-hidden="true" /> Aquicultura
                        </span>
                        <span className="inline-flex items-center gap-1.5 font-bold text-text">
                            <i className="size-[0.4375rem] rounded-pill bg-[#4bbd7a]" aria-hidden="true" /> Avicultura
                        </span>
                    </div>
                </div>
            </div>
