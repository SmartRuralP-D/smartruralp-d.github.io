    ...
    return (
        <section id="inicio" className="bg-white pt-[164px]">
            <div className="page-container">
                <div className="grid items-end gap-9 pb-[62px] [grid-template-columns:minmax(0,9fr)_minmax(140px,2fr)] max-[900px]:grid-cols-1">
                    <div>
                        ...
                        <h1 className="mb-7 mt-6 max-w-[920px] text-[clamp(3.25rem,7.5vw,7.2rem)] font-semibold leading-[.96] tracking-[-.055em]">
                            Sua solução para monitoramento em <em className="text-[var(--blue)] not-italic">tempo real</em>
                        </h1>
                        <p className="mb-0 max-w-[600px] text-[clamp(1rem,1.5vw,1.22rem)] leading-[1.65] text-[var(--text)]">
                        ...
                        <div className="mt-9 flex flex-wrap items-center gap-5">
                            <a
                                className="inline-flex min-h-[50px] items-center justify-center rounded-[6px] bg-[var(--blue)] px-[18px] text-[13px] font-extrabold text-white transition hover:-translate-y-0.5 hover:bg-[var(--blue-dark)]"
                                href="#solucoes"
                            >
                                Conheça nossas soluções <ArrowUpRight className="ml-2.5 size-[17px]" aria-hidden="true" />
                            </a>
                            <a
                                className="inline-flex min-h-[50px] items-center justify-center px-0 text-[13px] font-extrabold text-[var(--ink)] transition hover:-translate-y-0.5 hover:text-[var(--blue)]"
                                href="#contato"
                            >
                    ...
                    <div className="grid content-end justify-items-start gap-5 pb-1 max-[900px]:hidden">
                        <span className="text-xs font-extrabold tracking-[.08em] text-[var(--blue)]">01</span>
                        <p className="mb-0 max-w-[150px] text-[13px] leading-[1.5] text-[var(--muted)]">Do campo para perto de quem acompanha a operação.</p>
                        <a
                            className="grid size-[45px] place-items-center rounded-full border border-[var(--border)] text-[var(--blue)] transition hover:bg-[var(--blue)] hover:text-white"
                            href="#solucoes"
                ...
                <figure className="relative h-[clamp(400px,53vw,670px)] overflow-hidden bg-[var(--dark)]">
                    <img
                    ...
                    <div className="absolute right-8 top-8 z-10 grid w-[min(270px,34%)] gap-2 rounded-none border-l-[3px] border-[var(--blue)] bg-[rgba(16,19,22,.78)] p-[17px_18px] text-white backdrop-blur-lg max-[600px]:right-4 max-[600px]:top-4">
                        ...
                        <span className="inline-flex items-center gap-1.5 text-[11px] font-bold text-[#d5e4dc]">
                            <i className="size-[7px] rounded-full bg-[#4bbd7a]" aria-hidden="true" /> Normal
                        </span>
                    </div>
                </figure>
                <div className="flex items-center justify-between gap-5 pt-[18px] text-xs text-[var(--muted)]">
                    ...
                    <div className="flex gap-[25px]">
                        <span className="inline-flex items-center gap-1.5 font-bold text-[var(--text)]">
                            <i className="size-[7px] rounded-full bg-[#4bbd7a]" aria-hidden="true" /> Aquicultura
                        </span>
                        <span className="inline-flex items-center gap-1.5 font-bold text-[var(--text)]">
                            <i className="size-[7px] rounded-full bg-[#4bbd7a]" aria-hidden="true" /> Avicultura
                        </span>
                    </div>
                </div>
            </div>
