        ...
        >
            {flowSteps.map(({ icon: Icon, label, text }, index) => (
                <div key={label} className="contents">
                    <div className="grid grid-cols-[40px_minmax(0,1fr)] items-center gap-x-3 gap-y-2 lg:gap-y-0 max-[900px]:flex max-[900px]:flex-col max-[900px]:items-center max-[900px]:text-center">
                        <div className="contents max-[900px]:flex max-[900px]:items-center max-[900px]:gap-3">
                        ...
                        <strong className="mt-0.75 text-[0.8125rem] leading-[1.45] max-[900px]:text-center">{text}</strong>
                    </div>
                    {index < flowSteps.length - 1 && (
                        <ArrowRight className="h-4.25 w-4.25 self-center text-brand max-[900px]:rotate-90 max-[900px]:justify-self-center" aria-hidden="true" />
                    )}
                </div>
            ))}
        </div>
