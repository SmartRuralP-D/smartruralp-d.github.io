        ...
        <section id="solucoes" className="solutions-section section-block">
            <div className="container">
                <div className="section-heading section-heading-split">
                    ...
                    <p>A SmartRural acompanha diferentes realidades do campo. A tecnologia se adapta à operação, não o contrário.</p>
                </div>

                <div className="solutions-layout">
                    <article className="solution-feature">
                        <div className="solution-feature-image">
                            <img src={aquaculture.image} alt={aquaculture.imageAlt} width={1280} height={720} loading="lazy" />
