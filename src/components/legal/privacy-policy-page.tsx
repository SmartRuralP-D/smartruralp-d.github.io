    ...
    return (
        <div className="min-h-screen bg-[radial-gradient(circle_at_86%_8%,rgba(33,128,246,0.12),transparent_28rem),var(--surface)] text-ink">
            <header className="border-b border-border bg-white/80 backdrop-blur-md">
                <div className="page-container flex min-h-[84px] items-center justify-between gap-6">
                    <Brand href="/" />
                    <a
            ...
            <main className="py-[clamp(64px,10vw,132px)] pb-[110px]">
                <div className="page-container">
                    <div className="flex items-end justify-between gap-[30px] pb-[30px] max-[900px]:block">
                        <div className="inline-flex items-center gap-2 text-[11px] font-extrabold uppercase tracking-[0.12em] text-brand-strong [&_svg]:size-[18px]">
                            <ShieldCheck aria-hidden="true" />
                            SmartRural · Legal
                        </div>
                        <p className="m-0 max-w-[250px] text-right text-[13px] leading-[1.6] text-muted max-[900px]:mt-4 max-[900px]:text-left">
                    ...
                    <article className="grid grid-cols-[minmax(190px,0.6fr)_minmax(0,1.4fr)] gap-[clamp(32px,7vw,110px)] border border-[rgba(221,226,230,0.9)] bg-white p-[clamp(30px,6vw,78px)] shadow-[0_28px_70px_rgba(21,23,25,0.08)] max-[900px]:block max-[900px]:px-[22px] max-[900px]:pb-[34px] max-[900px]:pt-7">
                        <div className="sticky top-8 flex h-fit items-start gap-5 max-[900px]:static max-[900px]:mb-[48px]">
                            <span className="text-xs font-extrabold tracking-[0.08em] text-brand" aria-hidden="true" />
                            <div>
                                <h1>Privacy Policy</h1>
                            </div>
                        </div>

                        <div className="max-w-[680px] font-sans text-base leading-[1.75] text-text [&>p:first-child]:mt-0 [&>p:first-child]:text-[clamp(1.15rem,2vw,1.45rem)] [&_section]:mt-[46px] [&_section]:border-t [&_section]:border-[var(--border)] [&_section]:pt-[29px] [&_h2]:mb-[13px] [&_h2]:text-[1.05rem] [&_h2]:leading-[1.35] [&_p]:mb-[15px] [&_ul]:grid [&_ul]:gap-[9px] [&_ul]:pl-[21px] [&_a]:font-bold [&_a]:text-[var(--blue-dark)] [&_a]:underline">
            ...
            <footer className="bg-inverse py-6 text-[11px] text-white/60">
