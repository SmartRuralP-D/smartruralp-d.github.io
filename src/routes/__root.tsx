...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
    head: () => ({
        meta: [
            ...
            {
                name: 'description',
                content: 'A SmartRural ajuda operações de aquicultura e avicultura a acompanharem suas informações pelo celular e computador.'
            },
            { name: 'author', content: 'SmartRural' },
